...
import org.jboss.test.classloading.metadata.test.ManagedObjectClassLoadingDomainMetaDataUnitTestCase;
...
import org.jboss.test.classloading.metadata.xml.test.ClassLoadingTranslatorsMetaDataXmlUnitTestCase;
...
public class MetaDataTestSuite extends TestSuite
{
   ...
   public static Test suite()
   {
      ...
      suite.addTest(ClassLoadingTranslatorsMetaDataXmlUnitTestCase.suite());
